...
export default function CheckoutModal({ isOpen, onClose }: CheckoutModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto" role="dialog" aria-modal="true">
      ...
      <div
        onClick={onClose}
        className="fixed inset-0 bg-[#593222]/60 backdrop-blur-xs transition-opacity"
      />

      <div className="flex min-h-full items-center justify-center p-4 sm:p-6 lg:p-8">
        <div className="relative w-full max-w-2xl bg-[#FFFFFF] text-[#593222] shadow-2xl border border-[#593222]/15 overflow-hidden">

          {/* Header */}
          <div className="px-6 py-5 border-b border-[#593222]/10 flex items-center justify-between bg-[#FFFFFF]">
            <div className="flex items-center gap-3">
              <Truck className="w-5 h-5 text-[#B48C44]" />
              <h2 className="text-xl font-serif font-medium text-[#593222]">
                {completedOrder ? 'Order Confirmed' : 'Direct Roastery Checkout'}
              </h2>
            </div>
            <button
              onClick={onClose}
              className="p-1.5 text-[#593222]/60 hover:text-[#593222] hover:bg-[#593222]/5 transition-colors cursor-pointer"
            >
              <X className="w-5 h-5" />
            </button>
          </div>
          ...
          {completedOrder ? (
            <div className="p-8 text-center space-y-6">
              ...
              <div>
                ...
                <h3 className="text-3xl font-serif font-medium text-[#593222] mb-2">
                  Thank You, {completedOrder.shippingAddress.fullName.split(' ')[0]}
                </h3>
                <p className="text-sm font-sans text-[#593222]/80 max-w-md mx-auto">
              ...
              {/* Order Info Card */}
              <div className="bg-[#593222]/5 border border-[#593222]/10 p-5 text-left text-xs font-sans space-y-3">
                <div className="flex justify-between pb-2 border-b border-[#593222]/10">
                  <span className="text-[#593222]/60 font-semibold uppercase tracking-wider">Order Reference</span>
                  <span className="font-mono font-bold text-[#593222]">{completedOrder.orderNumber}</span>
                </div>
                <div className="flex justify-between pb-2 border-b border-[#593222]/10">
                  <span className="text-[#593222]/60 font-semibold uppercase tracking-wider">Total Paid</span>
                  <span className="font-serif font-bold text-[#B48C44] text-sm">₹{completedOrder.total} ({completedOrder.paymentMethod})</span>
                </div>
                <div className="flex justify-between pb-2 border-b border-[#593222]/10">
                  <span className="text-[#593222]/60 font-semibold uppercase tracking-wider">Estimated Dispatch</span>
                  <span className="text-[#593222] font-medium">Tomorrow, 10:00 AM (Chikmagalur Estates)</span>
                </div>
                <div>
                  <span className="text-[#593222]/60 font-semibold uppercase tracking-wider block mb-1">Delivering To</span>
                  <p className="text-[#593222] leading-relaxed">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center pt-2">
                ...
                <button
                  ...
                  className="border border-[#593222] text-[#593222] px-8 py-3.5 text-[11px] uppercase tracking-[0.2em] font-sans font-bold hover:bg-[#593222] hover:text-[#FFFFFF] transition-colors cursor-pointer"
                >
                  Continue Shopping
                </button>
              </div>
            ...
            <form onSubmit={handlePlaceOrder} className="p-6 sm:p-8 space-y-6">
              ...
              <div className="bg-[#593222]/5 border border-[#593222]/10 p-3 flex items-center justify-between text-xs font-sans">
                <div className="flex items-center gap-2">
                  <span className="font-bold text-[#593222]">{items.length} Blends</span>
                  <span className="text-[#593222]/50">•</span>
                  <span className="text-[#593222]/70">{items.reduce((s, i) => s + i.quantity, 0)} Total Packs</span>
                </div>
              ...
              <div>
                <h3 className="text-xs uppercase tracking-[0.2em] font-sans font-bold text-[#593222] mb-3 flex items-center gap-2">
                ...
                {!isAddingNewAddress && user && user.addresses.length > 0 ? (
                    ...
                    {user.addresses.map((addr) => {
                      ...
                      return (
                        <div
                          ...
                          className={`p-3.5 border text-xs cursor-pointer transition-all ${isSelected
                              ? 'border-[#593222] bg-[#593222]/5 ring-1 ring-[#593222]'
                              : 'border-[#593222]/15 hover:border-[#593222]/40'
                            }`}
                        >
                          <div className="flex justify-between items-center mb-1">
                            <span className="font-bold text-[#593222]">{addr.fullName}</span>
                            <span className="text-[9px] uppercase tracking-wider px-1.5 py-0.5 bg-[#FFFFFF] border border-[#593222]/20 font-sans">
                              {addr.label}
                            </span>
                          </div>
                          <p className="text-[#593222]/70 line-clamp-2 leading-relaxed">
                            {addr.street}, {addr.city} - {addr.pincode}
                          </p>
                          <span className="text-[11px] text-[#593222]/60 mt-1 block font-mono">
                            {addr.phone}
                          </span>
                        </div>
                      );
                  ...
                  <div className="space-y-3 bg-[#FFFFFF] p-4 border border-[#593222]/10">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      <div>
                        <label className="block text-[10px] uppercase tracking-wider font-sans font-semibold text-[#593222]/70 mb-1">
                          Full Name *
                        </label>
                        <input
                          type="text"
              ...
              <div>
                <h3 className="text-xs uppercase tracking-[0.2em] font-sans font-bold text-[#593222] mb-3">
                  2. Payment Method
                </h3>
                  ...
                  {[
                    ...
                    return (
                      <button
                        ...
                        className={`p-3 border text-left flex flex-col justify-between h-20 transition-all cursor-pointer ${isSelected
                            ? 'border-[#593222] bg-[#593222] text-[#FFFFFF]'
                            : 'border-[#593222]/20 hover:border-[#593222]/50 text-[#593222]'
                          }`}
                      >
                ...
                {paymentMethod === 'UPI' && (
                  <div className="mt-3 p-3 bg-[#593222]/5 border border-[#593222]/10">
                    <label className="block text-[10px] uppercase tracking-wider font-sans font-semibold text-[#593222]/70 mb-1">
                    ...
                    <input
                      ...
                      className="w-full border-b border-[#593222]/20 bg-transparent py-1.5 text-xs font-mono focus:outline-none focus:border-[#B48C44] text-[#593222]"
                    />
                    <span className="text-[9px] text-[#593222]/50 mt-1 block">Instant payment request will be sent to your UPI application.</span>
                  </div>
                )}
              </div>
              ...
              {/* Summary & Submit */}
              <div className="pt-4 border-t border-[#593222]/10 flex flex-col sm:flex-row items-center justify-between gap-4">
                <div className="flex items-center gap-2 text-[10px] text-[#593222]/60 font-sans">
                ...
                <button
                  ...
                  className="w-full sm:w-auto bg-[#593222] text-[#FFFFFF] px-10 py-4 text-[11px] uppercase tracking-[0.2em] font-sans font-bold hover:bg-[#B48C44] transition-colors cursor-pointer flex items-center justify-center gap-3 disabled:opacity-50"
                >
