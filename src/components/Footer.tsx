...
export default function Footer() {
  return (
    <footer className="bg-[#FFFFFF] text-[#593222] pt-20 pb-8 border-t border-[#593222]/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div>
            <h3 className="text-[#593222] text-[11px] uppercase tracking-[0.2em] font-sans font-bold mb-6">CHIKMAGALUR COFFEE WORKS</h3>
          ...
          <div>
            <h3 className="text-[#593222] text-[11px] uppercase tracking-[0.2em] font-sans font-bold mb-6">QUICK LINKS</h3>
            <ul className="space-y-4 text-sm opacity-80 font-sans">
              ...
              <li><Link to="/franchise" className="hover:text-[#B48C44] transition-colors">Franchise</Link></li>
          ...
          <div>
            <h3 className="text-[#593222] text-[11px] uppercase tracking-[0.2em] font-sans font-bold mb-6">POLICIES</h3>
            <ul className="space-y-4 text-sm opacity-80 font-sans">
          ...
          <div>
            <h3 className="text-[#593222] text-[11px] uppercase tracking-[0.2em] font-sans font-bold mb-6">CONTACT US</h3>
        ...
        <div className="border-t border-[#593222]/10 pt-8 flex flex-col md:flex-row justify-between items-center text-[10px] uppercase tracking-[0.15em] font-sans font-bold opacity-60">
